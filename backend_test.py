...
class RetailCoachAPITester:
    def __init__(self, base_url="https://user-flows.preview.emergentagent.com/api"):
    ...
    def test_subscription_lifecycle_with_reactivation(self):
        ...
        checkout_data = {
            "plan": "starter",
            "origin_url": "https://user-flows.preview.emergentagent.com/dashboard",
            "quantity": 2
        }
    ...
    def test_stripe_checkout_and_subscription_flow(self):
        ...
        checkout_data_starter = {
            "plan": "starter",
            "origin_url": "https://user-flows.preview.emergentagent.com"
        }
