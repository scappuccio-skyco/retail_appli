...
class RetailCoachAPITester:
    def __init__(self, base_url="https://dashboard-refactor-5.preview.emergentagent.com/api"):
    ...
    def test_subscription_lifecycle_with_reactivation(self):
        ...
        checkout_data = {
            "plan": "starter",
            "origin_url": "https://dashboard-refactor-5.preview.emergentagent.com/dashboard",
            "quantity": 2
        }
    ...
    def test_stripe_checkout_and_subscription_flow(self):
        ...
        checkout_data_starter = {
            "plan": "starter",
            "origin_url": "https://dashboard-refactor-5.preview.emergentagent.com"
        }
    ...
    def run_all_tests(self):
        ...
        # PRIORITY 1: Seller KPI History Aggregation (CURRENT REVIEW REQUEST - HIGHEST PRIORITY)
        self.test_seller_kpi_history_aggregation()

        # PRIORITY 2: AI Sales Analysis - Client Vouvoiement Fix + KPI Context Enhancement (CURRENT REVIEW REQUEST - HIGHEST PRIORITY)
