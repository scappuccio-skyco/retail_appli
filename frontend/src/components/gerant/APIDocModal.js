            ...
            <section className="mb-8">
              ...
              <div className="bg-white border border-gray-300 rounded-lg p-6 mb-6">
                <h4 className="text-lg font-bold text-orange-900 mb-3">
                  1. POST /api/integrations/kpi/sync ✍️
                </h4>
                ...
                <div className="bg-green-50 border-l-4 border-green-500 p-3 mb-4">
                  ...
                  <p className="text-xs text-green-800">
                    Cet endpoint est l'endpoint officiel pour synchroniser les KPI depuis vos systèmes externes (caisse, ERP).
                  </p>
                </div>
                
                <div className="bg-purple-50 border-l-4 border-purple-500 p-3 mb-4">
                  <p className="text-sm text-purple-900 font-semibold mb-2">
                    💡 Autres façons d'enregistrer les KPI :
                  </p>
                  <ul className="text-xs text-purple-800 ml-4 space-y-1">
                    <li>• <strong>Via Web (JWT) - Vendeur</strong> : <code className="bg-purple-200 px-1 rounded">POST /api/seller/kpi-entry</code> - Le vendeur enregistre ses propres KPI</li>
                    <li>• <strong>Via Web (JWT) - Manager</strong> : <code className="bg-purple-200 px-1 rounded">POST /api/manager/manager-kpi</code> - Le manager enregistre les KPI de ses vendeurs</li>
                  </ul>
                </div>
  ...
  "kpi_entries": [
    {
      ...
      "prospects": 35
                ...
                <p className="text-sm text-gray-600 italic mt-2">
                  💡 Pour obtenir les seller_id, utilisez <code className="bg-gray-200 px-1 rounded">GET /api/stores/my-stores</code> avec authentification Bearer Token (JWT)
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4 pb-2 border-b-2 border-red-500">❌ Endpoints Non Disponibles</h3>
              
              <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
                <p className="text-sm text-red-900 font-semibold mb-2">
                  ⚠️ Les endpoints suivants sont absents du runtime et ne sont pas disponibles :
                </p>
                <ul className="text-xs text-red-800 ml-4 space-y-1">
                  <li>• <code className="bg-red-200 px-1 rounded">GET /api/integrations/my-stores</code> - Non disponible</li>
                  <li>• <code className="bg-red-200 px-1 rounded">GET /api/integrations/my-stats</code> - Non disponible</li>
                  <li>• <code className="bg-red-200 px-1 rounded">POST /api/integrations/stores</code> - Non disponible</li>
                  <li>• <code className="bg-red-200 px-1 rounded">POST /api/integrations/stores/{'{'}store_id{'}'}/managers</code> - Non disponible</li>
                  <li>• <code className="bg-red-200 px-1 rounded">POST /api/integrations/stores/{'{'}store_id{'}'}/sellers</code> - Non disponible</li>
                  <li>• <code className="bg-red-200 px-1 rounded">PUT /api/integrations/users/{'{'}user_id{'}'}</code> - Non disponible</li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
                ...
                <ul className="text-xs text-blue-800 ml-4 space-y-1">
                  <li>• Pour créer des magasins : Utilisez <code className="bg-blue-200 px-1 rounded">POST /api/stores/</code> avec authentification Bearer Token (JWT)</li>
                  <li>• Pour lister les magasins : Utilisez <code className="bg-blue-200 px-1 rounded">GET /api/stores/my-stores</code> avec authentification Bearer Token (JWT)</li>
                  <li>• Pour les intégrations Enterprise : Consultez la documentation Enterprise API</li>
                </ul>
              </div>
            </section>
