              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                <div className="bg-white rounded-lg p-2 border-2 border-gray-200 hover:border-green-300 transition-all">
                  <div className="text-center mb-1.5">
                    ...
                    <p className="text-[9px] text-gray-600 mt-0.5">Les vendeurs saisissent leur CA quotidien</p>
                  </div>
                  <button
                    type="button"
                    onClick={() => handleKPIConfigUpdate('track_ca', !kpiConfig.track_ca)}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors mx-auto block ${
                ...
                <div className="bg-white rounded-lg p-2 border-2 border-gray-200 hover:border-green-300 transition-all">
                  <div className="text-center mb-1.5">
                    ...
                    <p className="text-[9px] text-gray-600 mt-0.5">Les vendeurs saisissent leur nombre de ventes</p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="bg-white rounded-lg p-2 border-2 border-gray-200 hover:border-purple-300 transition-all">
                  <div className="text-center mb-1.5">
                    ...
                    <p className="text-[9px] text-gray-600 mt-0.5">Les vendeurs saisissent leur nombre de clients servis</p>
                  </div>
                  <button
                    type="button"
                ...
                <div className="bg-white rounded-lg p-2 border-2 border-gray-200 hover:border-orange-300 transition-all">
                  <div className="text-center mb-1.5">
                    ...
                    <p className="text-[9px] text-gray-600 mt-0.5">Les vendeurs saisissent leur nombre d'articles vendus</p>
                  </div>
                  <button
                    type="button"
