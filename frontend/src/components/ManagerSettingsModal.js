                    ...
                    <div className="bg-white rounded-xl p-6 border-2 border-gray-200">
                      ...
                      {(() => {
                        ...
                        return completedObjectives.length === 0 ? (
                          <p className="text-center text-gray-500 py-8">Aucun objectif terminé</p>
                        ) : (
                          <div className="space-y-3">
                              ...
                              <div className="flex items-start justify-between">
                                ...
                                <div className="ml-4">
                                  <button
                                    ...
                                    className="bg-white text-red-600 hover:text-red-800 hover:bg-red-50 p-2 rounded border border-red-300 transition-all shadow-sm"
                                    title="Supprimer"
                                  >
                                    <Trash2 className="w-4 h-4" />
                                  </button>
