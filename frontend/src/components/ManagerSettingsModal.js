                              ...
                              <div className="flex-1">
                                ...
                                {(() => {
                                  ...
                                  if (objective.ca_target && objective.ca_target > 0) {
                                    ...
                                    const percent = Math.min(Math.round((progress_ca / objective.ca_target) * 100), 100);
                                    kpiProgressions.push({
                                      label: '💰 CA',
                                      current: progress_ca.toLocaleString('fr-FR'),
                                      target: objective.ca_target.toLocaleString('fr-FR'),
                                      unit: '€',
                                      percent
                                    });
                                  }
                                  if (objective.ventes_target && objective.ventes_target > 0) {
                                    ...
                                    const percent = Math.min(Math.round((progress_ventes / objective.ventes_target) * 100), 100);
                                    kpiProgressions.push({
                                      label: '📈 Ventes',
                                      current: progress_ventes,
                                      target: objective.ventes_target,
                                      unit: '',
                                      percent
                                    });
                                  }
                                  ...
                                  if (objective.panier_moyen_target && objective.panier_moyen_target > 0) {
                                    ...
                                    kpiProgressions.push({
                                      ...
                                      target: objective.panier_moyen_target.toFixed(2),
                                      unit: '€',
                                      percent
                                    });
                                  }
                                  if (objective.indice_vente_target && objective.indice_vente_target > 0) {
                                    ...
                                    const percent = Math.min(Math.round((progress_iv / objective.indice_vente_target) * 100), 100);
                                    kpiProgressions.push({
                                      label: '💎 Indice',
                                      current: progress_iv.toFixed(2),
                                      target: objective.indice_vente_target.toFixed(2),
                                      unit: '',
                                      percent
                                    });
                                  }
