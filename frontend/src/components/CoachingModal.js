...
import { X, Award, MessageSquare, RefreshCw } from 'lucide-react';
    ...
    <>
          ...
          <div className="flex-1 overflow-y-auto p-6">
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border-2 border-purple-200">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-2xl font-bold text-gray-800 mb-2">{dailyChallenge.title}</h3>
                          <p className="text-gray-700 mb-4">{dailyChallenge.description}</p>
                          
                          {dailyChallenge.kpi_name && (
                            <div className="bg-white rounded-lg p-4 border border-purple-200 mb-4">
                              <p className="text-sm text-gray-600 mb-1">🎯 Objectif à atteindre</p>
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    {onRefreshChallenge && (
                      <button
                        ...
                        className="mt-4 px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-all inline-flex items-center gap-2"
                      >
            ...
            {activeTab === 'analyse' && (
              <div>
                ...
                {debriefs.length > 0 ? (
                  <div className="space-y-4">
                    <p className="text-sm text-gray-600 mb-4">Dernières analyses ({debriefs.slice(0, 3).length})</p>
                    {debriefs.slice(0, 3).map((debrief, index) => (
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="bg-white rounded-lg p-4 border border-green-200">
                              <p className="text-gray-700 line-clamp-3">{debrief.analysis || debrief.feedback}</p>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      {showDailyChallengeModal && dailyChallenge && (
        <DailyChallengeModal
          ...
          onOpenHistory={onOpenChallengeHistory}
        />
      )}
