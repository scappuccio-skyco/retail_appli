  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-gray-800">Utilisateurs <span className="text-gray-500 text-base font-normal">({total} total)</span></h2>
        <button onClick={() => fetchUsers(page)} disabled={loading} className="p-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg transition-all">
      ...
      <div className="flex flex-wrap gap-3">
        <form onSubmit={handleSearch} className="flex gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 bg-white text-gray-700 placeholder-gray-400 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 w-64"
            />
          </div>
          <button type="submit" className="px-3 py-2 bg-[#1E40AF] text-white rounded-lg text-sm hover:bg-[#1E3A8A]">
            Chercher
          </button>
        </form>
        ...
        <select
          ...
          className="px-3 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg text-sm focus:outline-none"
        >
