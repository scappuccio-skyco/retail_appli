...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button onClick={() => scrollToSection('features')} className="text-[#2D3748] hover:text-[#FF6B35] transition-colors font-medium">
                Fonctionnalités
              </button>
              <button onClick={() => scrollToSection('pricing')} className="text-[#2D3748] hover:text-[#FF6B35] transition-colors font-medium">
                Tarifs
              </button>
              <button onClick={() => scrollToSection('faq')} className="text-[#2D3748] hover:text-[#FF6B35] transition-colors font-medium">
                FAQ
              </button>
              <button onClick={() => scrollToSection('contact')} className="text-[#2D3748] hover:text-[#FF6B35] transition-colors font-medium">
                Contact
              </button>
              <button
                onClick={() => navigate('/login')}
                className="px-4 py-2 text-[#FF6B35] border-2 border-[#FF6B35] rounded-lg hover:bg-orange-50 transition-colors font-medium"
              >
                Connexion
              </button>
              <button
                onClick={() => scrollToSection('pricing')}
                className="px-6 py-2 bg-gradient-to-r from-[#FF6B35] to-[#FF8C42] text-white rounded-lg hover:shadow-lg transition-all font-medium"
              >
                Essai Gratuit
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-100 rounded-2xl p-8 border-2 border-gray-200">
              <h3 className="text-2xl font-bold text-[#2D3748] mb-6">Sans Retail Performer AI</h3>
            ...
            {/* Solution */}
            <div className="bg-gradient-to-br from-[#0066FF]/10 to-[#0066FF]/20 rounded-2xl p-8 border-2 border-[#0066FF]">
              <h3 className="text-2xl font-bold text-[#0066FF] mb-6">Avec Retail Performer AI</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-3">
                    <Check className="w-6 h-6 text-[#00D9A3] flex-shrink-0 mt-0.5" />
                    <span className="text-[#2D3748]">{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0066FF] to-[#1E5EFF]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Debriefs Vendeurs */}
            <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-[#FF6B35]">
              <div className="w-16 h-16 bg-gradient-to-r from-[#FF6B35] to-[#FF8C42] rounded-xl flex items-center justify-center mb-6">
                <Target className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-[#2D3748] mb-4">Débriefs de Vente Intelligents</h3>
            ...
            {/* Gestion de Conflit */}
            <div className="bg-white rounded-2xl p-8 shadow-2xl border-2 border-[#0066FF]">
              <div className="w-16 h-16 bg-gradient-to-r from-[#0066FF] to-[#1E5EFF] rounded-xl flex items-center justify-center mb-6">
                <Users className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-[#2D3748] mb-4">Gestion de Conflit Manager-Vendeur</h3>
              <p className="text-[#2D3748] mb-6">
          ...
          <div className="mt-12 text-center">
            <div className="inline-block bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-2xl px-8 py-6">
              <p className="text-white text-lg mb-4">
                <strong className="text-[#FF8C42]">🎯 Résultat :</strong> Transformez chaque difficulté en leçon, 
                chaque conflit en opportunité de développement
              </p>
              <button
                onClick={() => scrollToSection('contact')}
                className="px-6 py-3 bg-gradient-to-r from-[#FF6B35] to-[#FF8C42] text-white font-semibold rounded-xl hover:shadow-lg transition-all"
              >
                Découvrir en Démo
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                color: 'from-[#00D9A3] to-[#00B886]',
                title: 'Challenges & Gamification',
                description: 'Objectifs motivants et système de niveaux pour engager vos équipes'
              }
            ].map((feature, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border-2 border-[#0066FF]/20 hover:border-[#FF6B35]">
