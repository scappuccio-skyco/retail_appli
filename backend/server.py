...
async def get_archived_sellers(
    ...
    if effective_store_id:
        filter_query["store_id"] = effective_store_id
    elif current_user.get('workspace_id'):
        filter_query["workspace_id"] = current_user.get('workspace_id')
...
app.add_middleware(
    CORSMiddleware,
    allow_credentials=True,
    allow_origin_regex=r"https://.*\.emergentagent\.com|http://localhost:3000|https://retailperformerai\.com|https://www\.retailperformerai\.com",
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["*"],
)
    ...
    try:
        ...
        for workspace in workspaces:
            ...
            result.append({
                ...
                "gerant": {
                    "id": gerant.get('id') if gerant else None,
                ...
                "sellers_count": total_active_sellers,
